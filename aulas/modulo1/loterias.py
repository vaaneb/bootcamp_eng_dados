...
df[df['Bola1'] ==  df['Bola1']] # removendo os nulos - limpando campos desnecessários
...
lista_campos = ['Bola1', 'Bola2', 'Bola3', 'Bola4', 'Bola5', 'Bola6', 'Bola7', 'Bola8', 'Bola9', 'Bola10', 'Bola11', 'Bola12','Bola13', 'Bola14', 'Bola15']
...
A combinação de pares, impares e primos mais frequente é o: {} com a frequência de: {}%'''.format(freq_nr[-1][0], freq_nr[0][0], resultado['Combinacao'].values[-1], int((resultado['p_freq'].values[-1]*100)*100)/100)
)
